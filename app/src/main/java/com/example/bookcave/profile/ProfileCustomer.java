        ...
        typeref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    sfirstname=documentSnapshot.getString("имя");
                    slastname=documentSnapshot.getString("фамилия");
                    sphno=documentSnapshot.getString("телефон");
                    saddress=documentSnapshot.getString("адресс");
                    spincode=documentSnapshot.getString("пинкод");
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(verifythis)){
                    ...
                    Toast.makeText(getApplicationContext(),"Введите фамилию",Toast.LENGTH_LONG).show();
                    return;
                }
                    ...
                    Toast.makeText(getApplicationContext(),"Введите пинкод",Toast.LENGTH_LONG).show();
                    return;
                }
                else{
        ...
        db.collection("Users").document(userid).set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()) {
                    ...
                    Toast.makeText(ProfileCustomer.this,"Информация обновлена", Toast.LENGTH_LONG).show();

                } else{
                    uProgress.setVisibility(View.INVISIBLE);
                    String errorMessage = Objects.requireNonNull(task.getException()).getMessage();
                    Toast.makeText(ProfileCustomer.this, "Ошибка: " + errorMessage, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
