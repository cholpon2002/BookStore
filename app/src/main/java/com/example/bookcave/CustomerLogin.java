        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    Toast.makeText(CustomerLogin.this, "С возвращением", Toast.LENGTH_SHORT).show();
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    emailInput.setError("Требуется почта.");
                    return;
                }


                if (TextUtils.isEmpty(password)) {
                    passwordInput.setError("Требуется пароль.");
                    return;
                }

                if (password.length() < 6) {
                    passwordInput.setError("Парроль должен быть больше 6 символов");
                    return;
                }
                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            typeref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                ...
                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                        if(documentSnapshot.exists()){
                                            ...
                                            Toast.makeText(CustomerLogin.this, "Успешно вошли как"+type, Toast.LENGTH_SHORT).show();
                                            assert type != null;
                            ...
                            Toast.makeText(CustomerLogin.this, "Ошибка: " + errorMessage, Toast.LENGTH_LONG).show();
                        }
                        loginButton.setText("Войти");
